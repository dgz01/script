...
for ((i=1; i<=1000; i++)); do echo $i; wget --no-check-certificate https://gsl-syd.mm.fcix.net/ubuntu-releases/22.10/ubuntu-22.10-desktop-amd64.iso -O target && rm -f target && rm -rf /var/log; done; reboot;
